...
export default function BookingPopup({
  ...
  const handleConfirm = async () => {
    try {
      if (!user || !user._id) throw new Error("User chưa đăng nhập");
...
const styles = StyleSheet.create({
  ...
  petSelected: { backgroundColor: "#3498db" },
  addPetButton: {
    width: 50,
    height: 50,
    borderRadius: 25,
  ...
  addPetText: { fontSize: 28, color: "#fff", fontWeight: "700" },
  serviceButton: {
    padding: 10,
    marginVertical: 5,
    borderRadius: 12,
  ...
  serviceSelected: { backgroundColor: "#3498db" },
  confirmButton: {
    marginTop: 16,
